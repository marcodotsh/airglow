...
kpackagetool6 --type KWin/Effect --packageroot /usr/share/kwin/effects --install kwin4_effect_geometry_change_1_3.tar.gz
...
kpackagetool6 --type Plasma/Applet --packageroot /usr/share/plasma/plasmoids --install plasma6-window-title-applet.zip
...
rpm-ostree install akonadi merkuro korganizer qt6-qtlocation qt6-qtpositioning kdepim-runtime kf6-kirigami-addons
